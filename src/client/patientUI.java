 ...
 * @author Tan Yi Nuo
 */
public class patientUI extends javax.swing.JPanel {

    circularQueue<patient> list = new patientADT<>();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String delete = c_name.getText();
        jTextArea1.setText("");
        list.dequeueSpecific(delete);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String password = c_tp.getText();
        String address = c_adr.getText();
        String email = c_typ.getText();
        pt = new patient(name, email, password, address);
        list.edit(pt, pt);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTextArea1.setText("");
        jTextArea1.append("Name\tPassword\tAddress\tEmail\n");
        Iterator<patient> it = list.getIterator();
        while (it.hasNext()) {
            Object ptss = it.next();
            patient p = (patient) ptss;
            jTextArea1.append(p.getName() + "\t" +p.getPassword() + "\t" + p.getAddress() + "\t" +  p.getEmail() + "\n");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        boolean result = list.search(name);
        if (result == true) {
